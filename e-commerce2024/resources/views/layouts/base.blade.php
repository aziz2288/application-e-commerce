                            ...
                            <div class="menu-left">
                                <div class="brand-logo">
                                    <a href="{{Route('app.index')}}">
                                        <img src="{{asset('assets/images/logo1.jpg')}}" class="h-logo img-fluid blur-up lazyload"
                                            alt="logo">
                                    </a>
                                </div>
                        ...
                        <div class="footer-contact">
                            <div class="brand-logo">
                                <a href="{{Route('app.index')}}" class="footer-logo float-start">
                                    <img src="{{asset('assets/images/logo1.jpg')}}" class="f-logo img-fluid blur-up lazyload"
                                        alt="logo">
                                </a>
                            </div>
                            <ul class="contact-lists" style="clear:both;">
                                <li>
                                    <span><b>phone:</b> <span class="font-light"> +216 0000000000</span></span>
                                </li>
                                <li>
                                    <span><b>Address:</b><span class="font-light"> Gouvernorat Nabeul,
                                            Tunisie</span></span>
                                </li>
                                <li>
                                    <span><b>Email:</b><span class="font-light"> contact@electronicShop.com</span></span>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="footer-links">
                            ...
                            <div class="footer-content">
                                <ul>
                                    ...
                                    <li>
                                        <a href="{{Route('shop.index')}}" class="font-dark">Shopping FAQs</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="sub-footer">
            <div class="container">
                <div class="row gy-3">
                    ...
                    <div class="col-md-6">
                        <p class="mb-0 font-dark">© 2024, electronicShop</p>
                    </div>
                </div>
            </div>
        </div>
