                                        ...
                                        @foreach ($brands as $brand)
                                            <li>
                                                <div class="form-check ps-0 custome-form-check">
                                                    <input class="checkbox_animated check-it" id="br{{$brand->id}}" name="brands" value="{{$brand->id}}" type="checkbox" @if(in_array($brand->id,explode(',',$q_brands))) checked="checked" @endif onchange="filterProductsByBrand(this)">
    ...
    <script>
        ...
        function filterProductsByBrand(brand){
            $("input[name='brands']:checked").each(function(){
                if(brands=="") brands +=this.value;
                else brands +=","+this.value;
            });
            $("#brands").val(brands);
            $("#frmFilter").submit();
        }
                ...
                success:function(data){
                    if(data.status==200){
                        ...
                        $.notify({
                            icon:"fa fa-check",
                            title:"success !",
                            message:"product seccessfully added to your wishlist"
                        });
                    }
                }
            });
