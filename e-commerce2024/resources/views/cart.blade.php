                                    ...
                                    <tr>
                                        <td>
                                            <a href="{{Route('shop.product.details',['slug'=>$item->model->slug])}}">
                                                <img src="assets/images/fashion/product/front/{{$item->model->image}}" class="blur-up lazyloaded"
                                                    alt="{{$item->model->name}}">
                                            </a>
                                        </td>
                                        <td>
                                    ...
                                    <div class="cart-box-details">
                                        <div class="total-details">
                                            <div class="top-details">
                                                <h3>Cart Totals</h3>
                                                <h6>Sub Total <span>${{Cart::instance()->subtotal()}}</span></h6>
                                                <h6>Tax <span>${{Cart::instance()->tax()}}</span></h6>

                                                <h6>Total <span>${{Cart::instance()->total()}}</span></h6>
                                            </div>
            ...
            @else
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <a href="{{Route('shop.index')}}" class="btn btn-warning mt-5">return to the shop</a>
                    </div>
                </div>
            @endif
        </div>
