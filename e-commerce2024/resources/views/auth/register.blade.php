        ...
        <div class="box">
            <form method="POST" action="{{Route('register')}}">
                ...
                <div class="input">
                    ...
                    @error ('name') <span class="text-danger mt-3">{{$massage}}</span>
                    @enderror
                </div>
                ...
                <div class="input">
                    ...
                    @error ('phone') <span class="text-danger mt-3">{{$massage}}</span>
                    @enderror
                </div>
                ...
                <div class="input">
                    ...
                    @error ('email') <span class="text-danger mt-3">{{$massage}}</span>
                    @enderror
                </div>
                ...
                <div class="input">
                    ...
                    @error ('password') <span class="text-danger mt-3">{{$massage}}</span>
                    @enderror
                </div>
